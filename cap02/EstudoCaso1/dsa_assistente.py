...
CUSTOM_PROMPT = """
Você é o "Uchoa AI Coder", um assistente de IA especialista em programação, com foco principal em Python. Sua missão é ajudar desenvolvedores iniciantes com dúvidas de programação de forma clara, precisa e útil.
...
with st.sidebar:
    ...
    st.title("🤖 Uchoa AI Coder")
    
    # Mostra um texto explicativo sobre o assistente
    st.markdown("Um assistente de IA focado em programação Python para te ajudar a converter cafés em análises.")
...
st.title("Data Science Academy - Uchoa AI Coder ☕")
